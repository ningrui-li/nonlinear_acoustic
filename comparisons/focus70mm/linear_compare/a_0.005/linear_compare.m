...
addpath /luscinia/nl91/nonlinear_acoustic/metrics/

%% Field II and KZK (linear) sim comparisons - 70 mm focus

% Field
fprintf('Field II:\n')
load /luscinia/nl91/nonlinear_acoustic/field/field_c52_70mm/a_0.005/dyna-I-f2.36-F3.5-FD0.070-a0.01.mat
...
load(['/luscinia/nl91/nonlinear_acoustic/kzk/field_ii_c52_focus70mm/'...
      'B_0.0/a_0.005_B_0/c52_70mm_intensity_field_field_ii_pressure_input.mat'])
...
%% center trace plot
figure(2)
centertrace('field_kzk_centertrace_c52_70mm.png', ['Field vs. KZK Center Trace' 10 'C5-2, 70 mm Focus, \alpha = 0.005 dB/cm/MHz'],...
            intensity_field_70mm, intensity_field_70mm_depth, 'Field II, C5-2, 70 mm Focus',...
            intensity_kzk_finput_70mm, intensity_kzk_70mm_depth, 'KZK, Field II Input, C5-2, 70 mm Focus')
