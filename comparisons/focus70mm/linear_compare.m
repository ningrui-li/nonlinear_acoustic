...
figure(3);
contourplots('kzk_70mm_depth.png', ['KZK, 70 mm Focus' nln 'Depth Plane'],...
...
figure(4);
contourplots('kzk_70mm_lateral.png', ['KZK, 70 mm Focus' nln 'Lateral Plane'],...
...
figure(5);
contourplots('kzk_70mm_elevational.png', ['KZK, 70 mm Focus' nln 'Elevational Plane'],...
