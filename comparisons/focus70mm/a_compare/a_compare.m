function [] = a_compare(atten)
% Input:
% atten = Attenuation (dB/cm/MHz) as a string (no units).
% Example: a_compare('0.03')
...
% KZK, B = 7
fprintf('KZK, B = 7:\n')
load(sprintf(['/luscinia/nl91/nonlinear_acoustic/kzk/field_ii_c52_focus70mm/B_7/',...
     'a_%s_B_7/c52_70mm_intensity_field_field_ii_pressure_input.mat'], atten));
...
eval(sprintf('print -dpng kzk_B7_diffplot_70mm_depth_a_%s.png', atten))
...
eval(sprintf('print -dpng kzk_B7_diffplot_70mm_lateral_a_%s.png', atten))
